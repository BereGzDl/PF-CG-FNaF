...
float	codo = 0.0f;
float	muneca = 0.0f;
float	indicemenor = 0.0f;
float	indicemayor = 0.0f;
float	mediomenor = 0.0f;
float	mediomayor = 0.0f;
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(indicemenor), glm::vec3(0.0f, 0.0, 1.0f)); //menor
		...
		model = glm::rotate(model, glm::radians(indicemayor), glm::vec3(0.0f, 0.0, 1.0f)); //mayor
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		...
		model = glm::rotate(model, glm::radians(mediomenor), glm::vec3(0.0f, 0.0, 1.0f)); //menor
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(10.4f, 0.5f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Model medio
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mediomayor), glm::vec3(0.0f, 0.0, 1.0f)); //mayor
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
